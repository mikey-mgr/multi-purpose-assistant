...
- Include brief reasons for the score (from reason/gap analysis)
...
- **subject**: A professional email subject line (with the user's full name if required), e.g. "Application for Digital Marketer - James Bond".
